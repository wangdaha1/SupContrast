...
def parse_option():
    ...
    opt.model_path = './save/noisy_LP_1/{}/{}_models'.format(opt.sslorsl, opt.dataset)  # 储存模型的位置
    opt.tb_path = './save/noisy_LP_1/{}/{}_tensorboard'.format(opt.sslorsl, opt.dataset)  # 储存训练的tb结果的位置
    opt.log_path = './save/noisy_LP_1/{}/{}_logs'.format(opt.sslorsl, opt.dataset)  # log记录结果
